...
with open(f'{list_file}.csv', 'r', encoding='utf-8') as csv_file:
    ...
    print('It will take few minutes, please be patient... \nOr press [Ctrl+C] to quit...')
    lists = []
    ...
    for csv_url in urls:
        ...
        pattern = re.compile(r'([\:\/\.\-\w]+)\/([\-\_\w]+)\.(jpg|png)(?=[\"\'])')
        ...
        for similar_url in unique_urls:
            ...
            image_request = requests.get(image_url + '/' + image_name + '.' + image_extension)
            # Saving the image
